...
*** Specify date
In admin -> variables :
from=2020-05-30, to=2020-06-01
*** Setup
Adds 35.189.254.61   airflowdata.ayl.io jupyter.ayl.io dev.airflowdata.ayl.io
to /etc/hosts
*** Manadge-upload (-dev)
Task can be launched individually
Clear will relaunch the task
The data for the correct day will be generated
Maybe adapts this for all the data airflow jobs
See airflow templates on how the date is loaded (ie {{ ds }})
** TODO POC see if the data stack can run on OVH
- S3
- GCS
- dataproc
** The infra teams get our infra
- See Pacome if pb
* Scala
** Akka
