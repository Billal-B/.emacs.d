...
*** fn
#+begin_src emacs-lisp
(defun bb/export-cv (filename)
  (interactive "fFile to export: ")
  (org-export-to-file 'moderncv filename)
  (org-latex-compile filename))

(defun bb/export-cv-current-file ()
    (interactive)
  (let ((tex-file (concat (file-name-base buffer-file-name) ".tex")))
...
(-each '("²" "<f12>")
 ...
 "mm" 'mc/edit-lines
 "ms" 'mc/mark-next-like-this
 "mr" 'mc/mark-previous-like-this
 "mo" 'mc/mark-all-like-this
